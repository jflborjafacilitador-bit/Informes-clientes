...
(async () => {
  ...
  n.parameters.jsonBody = "={{ JSON.stringify({ number: @{responseText=¡Hola! ??
...
Para poder orientarte perfectamente y mostrarte las opciones que mejor se adapten a tu estilo de vida, ¿me puedes contar para qué uso buscas la propiedad? ??; phone=5215646376057; instanceName=admin-prueba}.phone, options: { delay: 1500, presence: 'composing' }, text: @{responseText=¡Hola! ??
